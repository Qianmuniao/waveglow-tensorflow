...
parser.add_argument('--infer_mel_dir', dest='infer_mel_dir', default='/tts2/train_split_0.txt', help='Path to inference numpy files of mel spectrogram')
...
##Input Path##
parser.add_argument('--metadata_dir', dest='metadata_dir', default='/tts2/train_split_0.txt', help='Path to metadata.csv')
...
##Output Path##
parser.add_argument('--saving_path', dest='saving_path', default='/home/wsj/logdir/wg2/model', help='Path to save model if specified')
parser.add_argument('--loading_path', dest='loading_path', default='/home/wsj/logdir/wg2/model', help='Path to load model if specified')
parser.add_argument('--sampling_path', dest='sampling_path', default='/home/wsj/logdir/wg2/samples', help='Path to save samples if specified')
parser.add_argument('--summary_dir', dest='summary_dir', default='/home/wsj/logdir/wg2/summary', help='Path to save summaries')

##Audio Processing Params##
#STFT
parser.add_argument('--num_freq', dest='num_freq', type=int, default=2049, help='Number of frequency bins for STFT')
parser.add_argument('--hop_length', dest='hop_length', type=int, default=512, help='Hop length for STFT')
parser.add_argument('--window_size', dest='window_size', type=int, default=2200, help='Window size for STFT')
#Mels
parser.add_argument('--n_mel', dest='n_mel', type=int, default=160, help='Channel Size of Inputs')
parser.add_argument('--fmin', dest='fmin', type=int, default=125, help='Minimum Frequency of Mel Banks')
parser.add_argument('--fmax', dest='fmax', type=int, default=7600, help='Maximum Frequency of Mel Banks')
#Silence
parser.add_argument('--trim_hop_length', dest='trim_hop_length', type=int, default=512, help='Hop length for trimming silence')
parser.add_argument('--trim_window_size', dest='trim_window_size', type=int, default=4096, help='Window size for trimming silence')
parser.add_argument('--trim_top_db', dest='trim_top_db', type=float, default=40, help='Top dB for trimming scilence')
...
#Preprocessing
parser.add_argument('--sample_rate', dest='sample_rate', type=int, default=44100, help='Sample Rate of Input Audios')
parser.add_argument('--clip_to_value', dest='clip_to_value', type=float, default=4.0, help='Max/Min value of mel spectrogram')
parser.add_argument('--ref_db', dest='ref_db', type=float, default=20, help='Value to subtract to normalize mel spectrogram')
