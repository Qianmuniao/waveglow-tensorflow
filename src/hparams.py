...
#Silence
parser.add_argument('--trim_hop_length', dest='trim_hop_length', type=int, default=128, help='Hop length for trimming silence')
...
parser.add_argument('--trim_top_db', dest='trim_top_db', type=float, default=50, help='Top dB for trimming scilence')
